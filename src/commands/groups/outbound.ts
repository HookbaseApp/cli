...
export function registerEndpointsCommands(parent: Command): Command {
  ...
  endpoints
    ...
    .option('-d, --description <description>', 'Description')
    .option('-e, --event-types <types>', 'Deprecated: managed via subscriptions (ignored)')
    .option('-t, --timeout <seconds>', 'Request timeout in seconds (1-120)')
    .option('-r, --rate-limit <perSecond>', 'Rate limit in requests per second (0 = unlimited)')
